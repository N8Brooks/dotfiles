	...
	lsp = {
		...
		["server-settings"] = {
			...
			jdtls = function()
				...
				local project_name = home .. "/.local/share/eclipse/" .. vim.fn.fnamemodify(root_dir, ":p:h:t")
				...
				if root_dir then
					...
					if file then
						for line in file:lines() do
							table.insert(ws_folders_jdtls, string.format("file://" .. line))
						end
						file:close()
					end
				end
